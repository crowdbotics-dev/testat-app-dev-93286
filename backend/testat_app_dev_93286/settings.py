"""
Django settings for testat_app_dev_93286 project.
...
ROOT_URLCONF = 'testat_app_dev_93286.urls'
...
WSGI_APPLICATION = 'testat_app_dev_93286.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testat_app_dev_93286 API",
    "DESCRIPTION": "API documentation for testat_app_dev_93286 App",
    "VERSION": "v1",
}
